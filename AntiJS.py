...
def help2():
    ...
    helpMessage2 = "╔═══════════════════════╗" + "\n" + \
                  ...
                  "╚═══════════════════════╝" 
    return helpMessage2
    boy.sendContact(to, "U9d917c487562aa9b79bb3684a3dae2b6")
    ...
    try:
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  boy.sendContact(op.param1,"U9d917c487562aa9b79bb3684a3dae2b6")
           ...
           if wait["selfbot"] == True:
               ...
               if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["Mentiongift"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           idth = ["9cf180a6-74f1-4b00-ad3a-befcf12ddea8","bb682dc8-743e-459f-952f-8cd750d3c205"]
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                sw.sendText("U9d917c487562aa9b79bb3684a3dae2b6", 'Cek dulu')
                           ...
                           if msg._from in admin:
                              ...
                              if jumlah <= 1000:
                                  for var in range(0,jumlah):
                                      boy.sendMessage(midd, None, contentMetadata={'PRDID': '9cf180a6-74f1-4b00-ad3a-befcf12ddea8', 'PRDTYPE': 'THEME', 'MSGTPL': '5'}, contentType=9)
                                      k1.sendMessage(midd, None, contentMetadata={'PRDID': '9cf180a6-74f1-4b00-ad3a-befcf12ddea8', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}, contentType=9)
                                      k2.sendMessage(midd, None, contentMetadata={'PRDID': '9cf180a6-74f1-4b00-ad3a-befcf12ddea8', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}, contentType=9)
                                      k3.sendMessage(midd, None, contentMetadata={'PRDID': '9cf180a6-74f1-4b00-ad3a-befcf12ddea8', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}, contentType=9)
                                      k4.sendMessage(midd, None, contentMetadata={'PRDID': '9cf180a6-74f1-4b00-ad3a-befcf12ddea8', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}, contentType=9)
                                      k5.sendMessage(midd, None, contentMetadata={'PRDID': '9cf180a6-74f1-4b00-ad3a-befcf12ddea8', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}, contentType=9)
                                      k6.sendMessage(midd, None, contentMetadata={'PRDID': '9cf180a6-74f1-4b00-ad3a-befcf12ddea8', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}, contentType=9)
                                      k7.sendMessage(midd, None, contentMetadata={'PRDID': '9cf180a6-74f1-4b00-ad3a-befcf12ddea8', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}, contentType=9)
                                      k8.sendMessage(midd, None, contentMetadata={'PRDID': '9cf180a6-74f1-4b00-ad3a-befcf12ddea8', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}, contentType=9)
                                      k9.sendMessage(midd, None, contentMetadata={'PRDID': '9cf180a6-74f1-4b00-ad3a-befcf12ddea8', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}, contentType=9)
                                      k10.sendMessage(midd, None, contentMetadata={'PRDID': '9cf180a6-74f1-4b00-ad3a-befcf12ddea8', 'PRDTYPE': 'THEME', 'MSGTPL': '6'}, contentType=9)
